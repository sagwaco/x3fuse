...
struct LocalizationService {
    ...
    static let settingsSuperResolution = NSLocalizedString("settings.super_resolution", comment: "Super resolution setting")
    static let settingsSuperResolutionHelp = NSLocalizedString("settings.super_resolution.help", comment: "Super resolution help text")
    static let settingsSuperResolutionScale = NSLocalizedString("settings.super_resolution.scale", comment: "Super resolution scale setting")
    static let settingsSuperResolutionScaleHelp = NSLocalizedString("settings.super_resolution.scale.help", comment: "Super resolution scale help text")
    static let settingsSuperResolution1xSupersample = NSLocalizedString("settings.super_resolution.1x_supersample", comment: "1x Supersample option")
    static let settingsSuperResolution4xUpscale = NSLocalizedString("settings.super_resolution.4x_upscale", comment: "4x Upscale option")
    static let settingsSuperResolution16xUpscale = NSLocalizedString("settings.super_resolution.16x_upscale", comment: "16x Upscale option")
    static let settingsSuperResolution1xDescription = NSLocalizedString("settings.super_resolution.1x_description", comment: "1x Supersample description")
    static let settingsSuperResolution4xDescription = NSLocalizedString("settings.super_resolution.4x_description", comment: "4x Upscale description")
    static let settingsSuperResolution16xDescription = NSLocalizedString("settings.super_resolution.16x_description", comment: "16x Upscale description")
